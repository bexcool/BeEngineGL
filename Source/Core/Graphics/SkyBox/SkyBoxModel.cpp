...
SkyBoxModel::SkyBoxModel(CubeMap cubeMap)
{
    ...
    SetModelCustomSP("./Resources/Assets/Models/cube.obj", Material(ShaderInfo{.fragmentShaderPath = "./Resources/Shaders/skybox.frag.glsl", .vertexShaderPath = "./Resources/Shaders/skybox.vert.glsl", .useTexture = true}));
